...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'kiro' | 'grok' | 'zed' | 'composite'
...
const BADGE: Record<Platform, string> = {
  ...
  zed: 'bg-teal-500/10 text-teal-600 border-teal-500/30 dark:text-teal-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  zed: 'bg-teal-500/10 text-teal-600 dark:bg-teal-500/10 dark:text-teal-300',
...
const BORDER: Record<Platform, string> = {
  ...
  zed: 'border-teal-500/20 dark:border-teal-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  zed: 'border-teal-500/35 dark:border-teal-500/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  zed: 'bg-gradient-to-r from-teal-400 to-teal-500',
...
const TEXT: Record<Platform, string> = {
  ...
  zed: 'text-teal-600 dark:text-teal-400',
...
const ICON: Record<Platform, string> = {
  ...
  grok: 'text-zinc-800 dark:text-zinc-200',
  zed: 'text-teal-500 dark:text-teal-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  zed: 'bg-teal-500 text-white hover:bg-teal-600 active:bg-teal-700 dark:bg-teal-500/80 dark:hover:bg-teal-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  zed: 'bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'kiro' || p === 'grok' || p === 'zed' || p === 'composite'
}
