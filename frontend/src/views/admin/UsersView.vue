    ...
    <TablePageLayout>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-usage_zed="{ row }">
            <PlatformCostCell :usage="getPlatformUsage(row.id, 'zed')" />
          </template>
...
const allColumns = computed<Column[]>(() => [
  ...
  { key: 'usage_zed', label: t('admin.users.columns.usageZed'), sortable: false },
...
const DEFAULT_HIDDEN_COLUMNS = [
  ...
  'usage_kiro', 'usage_grok', 'usage_zed',
...
const USAGE_COLUMN_KEYS: readonly string[] = ['usage', 'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_kiro', 'usage_grok', 'usage_zed']
